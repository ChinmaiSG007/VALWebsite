    ...
    (e = {
      638: function (e) {
        ...
        function i(e, t) {
          ...
          // Check if the element has the "counter-with-plus" class before appending "+"
          if (e.classList.contains("counter-with-plus")) {
            e.innerHTML = u(o, t) + "+"; // Add "+" if the class exists
          } else {
            e.innerHTML = u(o, t); // Otherwise, just display the number
          }
          ...
          var i = setInterval(function () {
            ...
            // Again, check if the element has the "counter-with-plus" class
            if (e.classList.contains("counter-with-plus")) {
              e.innerHTML = u(a, t) + "+"; // Add "+" if the class exists
            } else {
              e.innerHTML = u(a, t); // Otherwise, just display the number
            }

            // Check if the counter has reached the end value and stop if true
            if (
              ((o = a) >= t.end && "inc" === n) ||
              (o <= t.end && "dec" === n)
            ) {
              if (e.classList.contains("counter-with-plus")) {
                e.innerHTML = u(t.end, t) + "+"; // Add "+" when the final value is reached
              } else {
                e.innerHTML = u(t.end, t); // Just show the final number without "+"
              }
              t.pulse &&
          ...
          function p(e, t) {
            e.forEach(function (e) {
              var r = e.target || e,
                n = v(r);
              if (n.duration <= 0) {
                if (r.classList.contains("counter-with-plus")) {
